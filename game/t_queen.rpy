...
label queen_saw:
    python:
        ...
        line = "I only managed to politely excuse myself by 9:30 and encountered Sergeant-Major Ritter near the cockpit. Now there's a man who knows how to not aggravate everyone near him. The world needs more like him. We were taking in the view in silence when that ghastly shriek rang out."
        choices = [ "Pressure.", "Ask something else." ]
        character.inputADV(line, choices, True)
